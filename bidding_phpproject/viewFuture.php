  ...
  <div>
    ...
    ?>
        ...
        <tr >
            ...
            <td rowspan="6" align="center"><img src=<?php echo $row['profile']; ?> class="mainimg" alt="not" height="300" width="400"><br> </td>
        </tr>
        <tr >
            <td><h4>Name :</td>
        ...
        <tr>
            ...
            <td><h4>Current price : <?php echo $row['current_price']; ?></h4></td>
        ...
        <tr align="center" bgcolor="#0ceb47">
            <?php
                ...
                echo "<td colspan=2><h4>&nbsp".$owner_name." has added this product to the auction. yow can directly contact the owner at <font color=\"red\">".$owner_email."</font> if you want to know more about this product </h4></td>";
    ...
    <?php if (strpos($row['img1'], 'jpg')){ ?><img src=<?php echo $row['img1']; ?> class="img" ><?php } ?>
    <?php if (strpos($row['img2'], 'jpg')){ ?><img src=<?php echo $row['img2']; ?> class="img" ><?php } ?>
    <?php if (strpos($row['img3'], 'jpg')){ ?><img src=<?php echo $row['img3']; ?> class="img" alt=""> <?php } ?>
    <?php if (strpos($row['img4'], 'jpg')){ ?><img src=<?php echo $row['img4']; ?> class="img" alt=""> <?php } ?>
    </div>
