...
<div class="row">
  ...
  <div>
    ...
    <div class="main"><h2><b>
    <?php
        echo "Hello ".$_SESSION["username"]."!!\nHere are some amazing past deals";
    ?></b></h2>
    ...
    ?>
        ...
        <?php
            ...
            {
            ?>
            <td><h3><b>Sold for : <?php echo $row['current_price']; ?></b></h3></td>
            <?php 
            }
            else
            {
        ...
        <tr>
            <td colspan = "2"><h2><a href = "viewDeal.php?id=<?php echo $row['ID']; ?>">View Deal</a><br>
        </h2></td>
        </tr>
